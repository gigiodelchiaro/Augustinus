...
consoantes_fortes = 'bcfjkpqtvxç'
consoantes_fracas = 'dglmnrsz'
...
def aplicar_regras(texto, divisor="-"):
    ...
    # Regra 4: Adicionar o divisor entre cada hiato (vogal seguida de vogal forte)
    ...
    # Exceção 3: Encontro de 3 vogais fracas seguidas (NÃO É 100% CORRETO)
    ...
    # Exceção 4: a + um + !vogal
    padrao_a_um_vogal = rf"(a)(um)([^{vogais}]|$)"
    texto = re.sub(padrao_a_um_vogal, r"\1" + divisor + r"\2", texto)
